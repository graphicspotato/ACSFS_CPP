...
//IMPORTANT NOTE:
//Since we crate the cube on stack after the execution of the function CreateUnitCube()
//We lost the cube because after the execution our cube deallocated from stack.
